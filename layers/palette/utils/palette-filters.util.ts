...
export function getPaletteSeasonFilter(): PaletteFilter[] {
  return [
    ...
    { id: 'deep-winter', label: { en: 'Deep Winter', ja: 'ディープウィンター', it: 'Inverno Profondo' }, palette: ['#00008B', '#191970', '#2F4F4F', '#4682B4', '#000080'] },
    { id: 'soft-summer', label: { en: 'Soft Summer', ja: 'ソフトサマー', it: 'Estate Morbida' }, palette: ['#B0E0E6', '#87CEFA', '#ADD8E6', '#4682B4', '#5F9EA0'] },
    { id: 'deep-autumn', label: { en: 'Deep Autumn', ja: 'ディープオータム', it: 'Autunno Profondo' }, palette: ['#8B4513', '#A0522D', '#D2691E', '#CD853F', '#B22222'] },
    { id: 'cool-winter', label: { en: 'Cool Winter', ja: 'クールウィンター', it: 'Inverno Freddo' }, palette: ['#4682B4', '#00BFFF', '#87CEEB', '#191970', '#5F9EA0'] },
    { id: 'cool-summer', label: { en: 'Cool Summer', ja: 'クールサマー', it: 'Estate Fresca' }, palette: ['#87CEEB', '#4682B4', '#00BFFF', '#5F9EA0', '#B0E0E6'] },
    { id: 'warm-spring', label: { en: 'Warm Spring', ja: 'ウォームスプリング', it: 'Primavera Calda' }, palette: ['#FFD700', '#FF6347', '#FFA500', '#FF7F50', '#F4A460'] },
    { id: 'warm-autumn', label: { en: 'Warm Autumn', ja: 'ウォームオータム', it: 'Autunno Caldo' }, palette: ['#CD853F', '#D2691E', '#A0522D', '#8B4513', '#FF8C00'] },
    { id: 'dark-autumn', label: { en: 'Dark Autumn', ja: 'ダークオータム', it: 'Autunno Scuro' }, palette: ['#8B0000', '#A52A2A', '#8B4513', '#5F9EA0', '#D2691E'] },
    { id: 'light-spring', label: { en: 'Light Spring', ja: 'ライトスプリング', it: 'Primavera Chiara' }, palette: ['#FFB6C1', '#FFD700', '#FFFACD', '#ADFF2F', '#FAFAD2'] },
    { id: 'dark-winter', label: { en: 'Dark Winter', ja: 'ダークウィンター', it: 'Inverno Scuro' }, palette: ['#191970', '#00008B', '#000080', '#2F4F4F', '#4682B4'] },
    { id: 'light-summer', label: { en: 'Light Summer', ja: 'ライトサマー', it: 'Estate Chiara' }, palette: ['#F5F5DC', '#87CEFA', '#ADD8E6', '#F8F8FF', '#E0FFFF'] },
    { id: 'bright-spring', label: { en: 'Bright Spring', ja: 'ブライトスプリング', it: 'Primavera Brillante' }, palette: ['#FF69B4', '#FFD700', '#FF6347', '#FF4500', '#FFA500'] },
    { id: 'bright-winter', label: { en: 'Bright Winter', ja: 'ブライトウィンター', it: 'Inverno Brillante' }, palette: ['#00CED1', '#00BFFF', '#4682B4', '#191970', '#87CEEB'] },
    { id: 'clear-winter', label: { en: 'Clear Winter', ja: 'クリアウィンター', it: 'Inverno Limpido' }, palette: ['#4682B4', '#00BFFF', '#2F4F4F', '#87CEEB', '#B0E0E6'] },
    { id: 'clear-spring', label: { en: 'Clear Spring', ja: 'クリアスプリング', it: 'Primavera Limpida' }, palette: ['#FFD700', '#FFA500', '#FF4500', '#FF6347', '#F4A460'] },
    { id: 'warm-summer', label: { en: 'Warm Summer', ja: 'ウォームサマー', it: 'Estate Calda' }, palette: ['#FFA07A', '#FFD700', '#FF8C00', '#FF6347', '#FF7F50'] },
    { id: 'soft-winter', label: { en: 'Soft Winter', ja: 'ソフトウィンター', it: 'Inverno Morbido' }, palette: ['#DCDCDC', '#F8F8FF', '#F0FFFF', '#87CEFA', '#B0E0E6'] },
    { id: 'cool-autumn', label: { en: 'Cool Autumn', ja: 'クールオータム', it: 'Autunno Fresco' }, palette: ['#8B4513', '#A0522D', '#D2691E', '#5F9EA0', '#4682B4'] },
    { id: 'warm-fall', label: { en: 'Warm Fall', ja: 'ウォームフォール', it: 'Autunno Caldo' }, palette: ['#D2691E', '#CD853F', '#A0522D', '#8B4513', '#FF8C00'] },
    { id: 'cold-summer', label: { en: 'Cold Summer', ja: 'コールドサマー', it: 'Estate Fredda' }, palette: ['#4682B4', '#00BFFF', '#5F9EA0', '#87CEEB', '#B0E0E6'] },
    { id: 'light-autumn', label: { en: 'Light Autumn', ja: 'ライトオータム', it: 'Autunno Chiaro' }, palette: ['#FFD700', '#FF8C00', '#FFA500', '#F4A460', '#FF7F50'] },
    { id: 'dark-summer', label: { en: 'Dark Summer', ja: 'ダークサマー', it: 'Estate Scura' }, palette: ['#8B0000', '#A52A2A', '#5F9EA0', '#4682B4', '#2F4F4F'] },
    { id: 'muted-autumn', label: { en: 'Muted Autumn', ja: 'ミュートオータム', it: 'Autunno Smorzato' }, palette: ['#A0522D', '#8B4513', '#D2691E', '#CD853F', '#FF8C00'] },
    { id: 'bright-autumn', label: { en: 'Bright Autumn', ja: 'ブライトオータム', it: 'Autunno Brillante' }, palette: ['#FFA500', '#FF4500', '#FF6347', '#FFD700', '#F4A460'] },
    { id: 'light-winter', label: { en: 'Light Winter', ja: 'ライトウィンター', it: 'Inverno Chiaro' }, palette: ['#F8F8FF', '#F0F8FF', '#DCDCDC', '#E0FFFF', '#87CEFA'] },
    { id: 'bright-summer', label: { en: 'Bright Summer', ja: 'ブライトサマー', it: 'Estate Brillante' }, palette: ['#FF69B4', '#FFD700', '#FFA500', '#87CEEB', '#00CED1'] }
  ].sort((a, b) => a.id.localeCompare(b.id));
}
