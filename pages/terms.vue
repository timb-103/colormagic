<template>
  <div class="prose pt-8">
    ...
    <ol class="list-decimal ml-5">
      <li>The purpose of this Agreement is to define the terms and conditions of the Service and the relationship of rights and obligations between the Organization and the registered user regarding the use of the Service, and shall apply to all relationships between the registered user and the Organization regarding the use of the Service.</li>
      <li>Rules regarding the use of the Service posted by the Organization within the Service shall constitute a part of this Agreement.</li>
    ...
    <ul class="list-disc ml-5">
      <li>"Service Usage Contract" means the contract for the use of the Service between the Organization and a Registered User, which is made under the terms and conditions of this Agreement.</li>
      <li>"Intellectual Property Rights" means copyrights, patent rights, utility model rights, design rights, trademark rights, and other intellectual property rights (including the right to acquire such rights or to apply for registration of such rights).</li>
      <li>"Posted Data" means any content (including but not limited to text, images, video, and other data) posted or otherwise transmitted by Registered Users using the Service.</li>
    ...
    <ol class="list-decimal ml-5">
      <li>A person who wishes to use the Service (hereinafter referred to as "Prospective User") agrees to comply with these Terms of Use and provides the Organization with certain information as specified by the Organization (hereinafter referred to as "Registration Matters") in the manner specified by the Organization.</li>
      <li>The Organization shall grant an account to the applicant who has applied for registration in accordance with paragraph 1.</li>
      <li>Upon completion of the registration, a service use agreement will be established between the registered user and the Organization, allowing them to use the Service in accordance with these Terms of Use.</li>
    ...
    <ol class="list-decimal ml-5">
      <li>Registered Users shall, at their own responsibility, properly manage and store account information and passwords for external services related to the Service.</li>
      <li>The Organization shall deem that a registered user with such account has used the Service when the Organization confirms that the Identity Confirmation Information matches.</li>
    ...
    <ul class="list-disc ml-5">
      <li>Actions that violate laws and regulations or are related to criminal acts</li>
      <li>Fraud or threats against the Organization, other users of the Service, or other third parties</li>
      <li>Acts that offend public order and morals</li>
      <li>Infringement of intellectual property rights, portrait rights, rights of privacy, honor, or other rights or interests of the Organization, other users of the Service, or other third parties</li>
      <li>Transmitting harmful information to the Organization or other users</li>
      <li>Reverse engineering or unauthorized analysis of software provided by the Organization</li>
      <li>Unauthorized access to the Organization's systems</li>
      <li>Advertising or conducting business on the Service without the Organization's prior consent</li>
    ...
    <ol class="list-decimal ml-5">
      <li>All intellectual property rights related to the Service belong to the Organization or its licensors.</li>
    ...
    <ol class="list-decimal ml-5">
      <li>The Organization does not warrant that the Service will meet the Registered User's expectations or be free from defects.</li>
